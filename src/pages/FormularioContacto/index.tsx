    ...
    <div id="contactos">
      ...
      <section className="font-sans">
        <div className="md:flex sm:h-screen">
          <div className="md:w-1/2 lg:pl-60 bg-gradient-to-tl from-blueblack-main via-blueblack-main to-redmain-800 p-12 text-white flex flex-col justify-center">
            <h2 className="text-sm bg-blueblack-main text-white p-0.5 px-4 w-fit rounded-md mb-2">
              Soporte 24/7
            </h2>
            <p className="text-3xl font-bold mb-8">
              Estamos aquí para responder tus preguntas y ayudarte en tu proceso
              educativo.
            </p>
          ...
          <div className="md:w-1/2 p-12 lg:pr-60 flex flex-col justify-center">
